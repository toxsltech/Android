...
class CheckoutAdapter(val baseActivity: BaseActivity, private val productData: ArrayList<CartProductData>) : BaseAdapter(), BaseAdapter.OnPageEndListener {
    ...
    override fun onBindViewHolder(holder: BaseViewHolder, position: Int) {
        ...
        binding.itemNameTV.text = data.productName
        binding.quantityTV.text = data.price.plus(" x ").plus(data.addedQuantity.toString())
    }
